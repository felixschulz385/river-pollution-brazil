...
from climate.fetch.era5_land_arco import (
    arco_store_url,
    open_arco_group_dataset,
)
from climate.preprocess.era5_land_arco import (
...
def test_preprocess_era5_land_arco_writes_store_and_marks_progress(
    ...
    monkeypatch.setattr(
        "climate.preprocess.era5_land_arco.load_or_create_geobox_state",
        lambda root_dir=".": geobox_state,
    )
    monkeypatch.setattr(
        "climate.preprocess.era5_land_arco.ARCO_GROUPS",
    ...
    monkeypatch.setattr(
        "climate.preprocess.era5_land_arco.open_arco_group_dataset",
